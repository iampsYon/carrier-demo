...
# =========================================================
# MAIN CONTENT CONTAINER (The "Ghosting" Fix)
# =========================================================
# We create a single empty container for the main page content.
# This forces Streamlit to clear the previous step's UI entirely
# before rendering the new step inside this container.
